...
from spskit.sps.package import get_xml_packages
from spskit.sps.article_packages import get_articles_packages
...
class Reception:
    ...
    class get_article_packages_pipe(plumber.Pipe):
        def transform(self, data):
            ...
            article_packages = get_articles_packages(xml_packages)
